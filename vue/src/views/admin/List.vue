      ...
      <el-table :data="tableData" stripe>
        ...
        <el-table-column label="Status" width="100">
          <template v-slot="scope2">
            <el-switch v-model="scope2.row.status" active-color="#13ce66" inactive-color="#ff4949"
        ...
        <el-table-column prop="street" label="Street" width="100"></el-table-column>
        ...
        <el-table-column label="Operations" width="300">
          <template v-slot="scope">
            ...
            <el-popconfirm confirm-button-text='Yes' cancel-button-text='No'
              title="Are you sure you want to delete this row of data？" @confirm="del(scope.row.email)">
              <el-button style="margin-left: 2px;" slot="reference" type="danger">Delete</el-button>
            </el-popconfirm>
            <!-- reset password -->
            <el-popconfirm confirm-button-text='Yes' cancel-button-text='No'
              title="Are you sure you want to reset this admin's password？" @confirm="resetPass(scope.row)">
